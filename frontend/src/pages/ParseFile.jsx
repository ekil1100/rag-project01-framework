                    ...
                    <div className='p-4 border rounded-lg bg-white shadow-sm'>
                        ...
                        <div className='mt-4'>
                            ...
                            <select
                                value={parsingOption}
                                onChange={(e) =>
                                    setParsingOption(e.target.value)
                                }
                                className='block w-full p-2 border rounded'
                            >
                        ...
                        <div className='p-4'>
                            ...
                            <div className='mb-4 p-3 border rounded bg-gray-100'>
                                ...
                                <div className='text-sm text-gray-600'>
                                    <p>
                                        Total Pages:{' '}
                                        {parsedContent.metadata?.total_pages}
                                    </p>
                                    <p>
                                        Parsing Method:{' '}
                                        {parsedContent.metadata?.parsing_method}
                                    </p>
                                    <p>
                                        Timestamp:{' '}
                                        {parsedContent.metadata?.timestamp &&
                                            new Date(
                                                parsedContent.metadata.timestamp,
                                            ).toLocaleString()}
                                    </p>
