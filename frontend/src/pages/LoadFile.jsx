    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            if (loadingMethod === 'unstructured') {
                ...
                formData.append(
                    'chunking_options',
                    JSON.stringify(chunkingOptions),
                )
            }
    ...
    const handleViewDocument = async (doc) => {
        try {
            ...
            const response = await fetch(
                `${apiBaseUrl}/documents/${doc.name}.json`,
            )
            if (!response.ok) {
                throw new Error(`HTTP error! status: ${response.status}`)
            }
                        ...
                        <div>
                            ...
                            <div className='mb-4 p-3 border rounded bg-gray-100'>
                                ...
                                <div className='text-sm text-gray-600'>
                                    <p>
                                        Pages:{' '}
                                        {loadedContent.total_pages || 'N/A'}
                                    </p>
                                    <p>
                                        Chunks:{' '}
                                        {loadedContent.total_chunks || 'N/A'}
                                    </p>
                                    <p>
                                        Loading Method:{' '}
                                    ...
                                    <p>
                                        Chunking Method:{' '}
                                        {loadedContent.chunking_method || 'N/A'}
                                    </p>
                                    <p>
                                        Processing Date:{' '}
                                        {loadedContent.timestamp
                                            ? new Date(
                                                  loadedContent.timestamp,
                                              ).toLocaleString()
                                            : 'N/A'}
                                    ...
                                    <div className='mt-4 space-y-3'>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type='number'
                                                value={
                                                    chunkingOptions.newAfterNChars
                                                }
                                                onChange={(e) =>
                                                    setChunkingOptions(
                                                        (prev) => ({
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type='number'
                                                value={
                                                    chunkingOptions.combineTextUnderNChars
                                                }
                                                onChange={(e) =>
                                                    setChunkingOptions(
                                                        (prev) => ({
                                    ...
                                    <div className='mt-4 space-y-3'>
                                        ...
                                        <div className='flex items-center'>
                                            <input
                                                type='checkbox'
                                                checked={
                                                    chunkingOptions.multiPageSections
                                                }
                                                onChange={(e) =>
                                                    setChunkingOptions(
                                                        (prev) => ({
